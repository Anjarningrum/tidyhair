...
<div class="col-md-9 ms-sm-auto col-lg-9 px-md-4 border">
    ...
    async function produkchart(){
                      ...
                      var data = [];
                      const res = await fetch('/adminbranch/getproduk', {
                      method: 'GET', 
                      headers: {
    ...
    async function customerchart(){
                      console.log('produk clicked');
                      var data = [];
                      const res = await fetch('/adminbranch/getcustomer', {
                      method: 'GET', 
                      headers: {
                          'Content-Type': 'application/json',
                          'Accept': 'application/json',
              ...
              async function branchchart(){
                      console.log('produk clicked');
                      var data = [];
                      const res = await fetch('/adminbranch/getbranch', {
                      method: 'GET', 
                      headers: {
                          'Content-Type': 'application/json',
                          'Accept': 'application/json',
              ...
              async function barberchart(){
                      console.log('produk clicked');
                      var data = [];
                      const res = await fetch('/adminbranch/getbarber', {
                      method: 'GET', 
                      headers: {
                          'Content-Type': 'application/json',
                          'Accept': 'application/json',
              ...
              async function jasachart(){
                      console.log('produk clicked');
                      var data = [];
                      const res = await fetch('/adminbranch/getjasa', {
                      method: 'GET', 
                      headers: {
                          'Content-Type': 'application/json',
                          'Accept': 'application/json',

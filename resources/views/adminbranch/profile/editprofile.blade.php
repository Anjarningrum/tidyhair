...
<div class="row my-3 mx-2 px-4">
    ...
    <form method="POST" action="{{ route('adminbranch.profile.update',['id' => $user->id]) }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="alamat" type="alamat" class="form-control py-1 my-2 @error('alamat') is-invalid @enderror" name="alamat" value="{{ $user->alamat }}">

        ...
        <div class="card">
            ...
            <div class="row mb-3">
                ...
                <div class="col text-end mt-2">
                    <a href="{{ route('adminbranch.pembatalanbarang') }}" class="customBtn ms-5">Pembatalan Barang</a>
                </div>
            </div>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <div style="margin-bottom:5px;">
                                <a href="{{ route('adminbranch.editorderbarang', ['id'=>$o->id]) }}" class="customBtnEdit">
                                    Edit
                                </a>
                            </div>
                                <a href="{{ route('adminbranch.orderbarang.delete', ['id'=>$o->id]) }}" onclick="return confirm('Yakin Hapus data')" class="customBtnDelete">
                                    Delete
                                </a>
                        </td>
                    </tr>

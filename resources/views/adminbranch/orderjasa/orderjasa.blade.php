        ...
        <div class="card">
            ...
            <div class="row mb-3">
                ...
                <div class="col text-end mt-2">
                    <a href="{{ route('adminbranch.pembatalanjasa') }}" class="customBtn ms-5">Pembatalan Jasa</a>
                </div>
            </div>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <div style="margin-bottom:5px;">
                                <a href="{{ route('adminbranch.editorderjasa', ['id'=>$o->id]) }}" class="customBtnEdit">
                                    Edit
                                </a>
                            </div>
                                <a href="{{ route('adminbranch.orderjasa.delete', ['id'=>$o->id]) }}" onclick="return confirm('Yakin Hapus data')" class="customBtnDelete">
                                    Delete
                                </a>
                        </td>
                    </tr>

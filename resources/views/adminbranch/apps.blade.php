                                    ...
                                    <div class="row">
                                        <div class="col-2">
                                            <a class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-current="page" href="#" style="font-family: nunito;color: #FFFFFF;">
                                                <img src="{{asset('images/adminpusat/IconDataMaster.png')}}" class="icn" style="margin-right: 15px">
                                                Data Master   
                                            </a>
...
<li class="nav-item dropdown">
    <div class="row">
        <div class="col-2">
            <a class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-current="page" href="#" style="font-family: nunito;color: #FFFFFF;">
                <img src="{{asset('images/adminpusat/IconOrder.png')}}" class="icn" style="margin-right: 15px">
                Order   
            </a>
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="{{ route('adminbranch.barber') }}">Barber</a></li>

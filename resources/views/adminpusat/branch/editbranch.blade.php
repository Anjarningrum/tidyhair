...
<div class="row my-3 mx-2 px-4">
    ...
    <form method="POST" action="{{ route('adminpusat.branch.update',['id' => $user->id]) }}" enctype="multipart/form-data">
        @csrf
        <div class="form-group row">
            <label for="name" class="col-md-4 col-form-label text-md-right data py-0 my-2">{{ __('Name :') }}</label>

            <div class="col-md-6">
                <input id="name" type="text" class="form-control py-1 my-2 @error('name') is-invalid @enderror" name="name" value="{{ $user->name }}" required autocomplete="name" autofocus>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="email" type="email" class="form-control py-1 my-2 @error('email') is-invalid @enderror" name="email" value="{{ $user->email }}" required autocomplete="email">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <span class="form-control py-1 my-2">{{ $user->getRoleNames()[0] }}</span>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="no_telepon" type="no_telepon" class="form-control py-1 my-2 @error('no_telepon') is-invalid @enderror" name="no_telepon" value="{{ $user->no_telepon }}">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="alamat" type="alamat" class="form-control py-1 my-2 @error('alamat') is-invalid @enderror" name="alamat">

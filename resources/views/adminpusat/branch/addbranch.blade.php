...
<div class="col-md-9 ms-sm-auto col-lg-9 px-md-4 border">
      ...
      <div class="row">
        <form method="POST" class="col" action="{{ route('adminpusat.branch.save') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="no_telepon" type="no_telepon" class="form-control py-1 my-2 @error('no_telepon') is-invalid @enderror" name="no_telepon" >

...
<div class="row my-3 mx-2 px-4">
    ...
    <form method="POST" action="{{ route('adminpusat.artikel.save') }}">
        @csrf
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="isi" type="text" class="form-control px-0 py-1 my-2 @error('isi') is-invalid @enderror" name="isi" required autocomplete="isi">
            </div>
        </div>
